...
<h1>Planos <a href="{{ route('plans.create')}}" class="btn btn-sm btn-outline-primary ">
        ...
        <table class="table table condensed">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('plans.show',$plan->url)}}" target="_blank"
                            class="btn btn-sm btn-success">Ver</a>
                    </td>
                    <td>
                        <a href="{{route('plan.edit',$plan->url)}}" target="_blank"
